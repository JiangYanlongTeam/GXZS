...
<script language="javascript">
    ...
    function openDialogForCw(url,title) {
        ...
        dlg.Width=1024;//定义长度
        dlg.Height=280;
        dlg.URL='/interface/jiangyl/gfgs/'+url+'.jsp?id=<%=workflowid%>';
        dlg.Title=title;
        dlg.show();
    }
    ...
    jQuery(document).ready(function() {
        if (isNode) {
            jQuery("<input type=\"button\" onclick=\"openDialogForCw('cxdgyfk_pzyl','冲销对公预付款凭证预览')\" value=\"凭证预览\" class=\"e8_btn_top\">").appendTo(jQuery("#pzyl"));
        }
