...
function visualstampclient(cebnames) {
	//alert("gostamp");
      var strAuxInfo = "<DeviceStyle>28</DeviceStyle>";

      var AffixRegisterURL,PrintURL,cebname,dept,nRet,varRetXml;
      ...
      nRet = objStampClientTool.LocalSealStampEx2(cebname, dept, AffixRegisterURL, PrintURL, strAuxInfo, varRetXml)
      return nRet;
}
