...
public class ClientSystemsUpdate  extends jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ClientSystemsCreate  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ClientSystemsID recordIdentification;
     ...
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ClientSystemsID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ClientSystemsID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ClientSystemsUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ClientSystemsID"));
