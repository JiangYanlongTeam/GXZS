...
public class TradePartnersResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners[] tradePartners;
    ...
    public TradePartnersResultSet(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners[] tradePartners) {
        super(
            executionStatus);
     ...
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners[] getTradePartners() {
        return tradePartners;
    }
     ...
     * @param tradePartners
     */
    public void setTradePartners(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners[] tradePartners) {
        this.tradePartners = tradePartners;
    }

    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners getTradePartners(int i) {
        return this.tradePartners[i];
    }

    public void setTradePartners(int i, jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TradePartners _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "TradePartnersResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tradePartners");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "tradePartners"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "TradePartners"));
