...
public class Regions  extends jsgx_mdm_business_partner.beans.ws.mdm.sap.com.RegionsUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "Regions"));
