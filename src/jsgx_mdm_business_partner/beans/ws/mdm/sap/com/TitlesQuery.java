...
public class TitlesQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TitlesCriteria criteria;
    ...
    public TitlesQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TitlesCriteria criteria,
    ...
    /**
     * Gets the criteria value for this TitlesQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TitlesCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this TitlesQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.TitlesCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this TitlesQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this TitlesQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TitlesQuery)) return false;
        TitlesQuery other = (TitlesQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TitlesQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "TitlesQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "TitlesCriteria"));
