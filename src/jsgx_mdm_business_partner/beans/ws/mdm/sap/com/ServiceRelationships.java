...
public class ServiceRelationships  extends jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsUpdate  implements java.io.Serializable {
    ...
    public ServiceRelationships(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsID recordIdentification,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ServiceRelationships"));
