...
public class CustomerTypeID  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeDisplayFields displayFields;
    ...
    public CustomerTypeID(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeDisplayFields displayFields) {
     ...
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeDisplayFields getDisplayFields() {
        return displayFields;
    }
     ...
     * @param displayFields
     */
    public void setDisplayFields(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeDisplayFields displayFields) {
        this.displayFields = displayFields;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerTypeID"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerTypeDisplayFields"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
