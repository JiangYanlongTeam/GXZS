...
public class OperationQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationCriteria criteria;
    ...
    public OperationQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationCriteria criteria,
    ...
    /**
     * Gets the criteria value for this OperationQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this OperationQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this OperationQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this OperationQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationQuery)) return false;
        OperationQuery other = (OperationQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationCriteria"));
