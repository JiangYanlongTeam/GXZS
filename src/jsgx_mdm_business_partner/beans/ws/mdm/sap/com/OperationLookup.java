...
public class OperationLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this OperationLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this OperationLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this OperationLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this OperationLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationLookup)) return false;
        OperationLookup other = (OperationLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationLookup"));
