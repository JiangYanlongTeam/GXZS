...
public class OperationID  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint1 uniqueConstraint1;

    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint2 uniqueConstraint2;
    ...
    public OperationID(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint1 uniqueConstraint1,
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint2 uniqueConstraint2) {
    ...
    /**
     * Gets the uniqueConstraint1 value for this OperationID.
     * 
     * @return uniqueConstraint1
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint1 getUniqueConstraint1() {
        return uniqueConstraint1;
    }


    /**
     * Sets the uniqueConstraint1 value for this OperationID.
     * 
     * @param uniqueConstraint1
     */
    public void setUniqueConstraint1(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint1 uniqueConstraint1) {
        this.uniqueConstraint1 = uniqueConstraint1;
    }


    /**
     * Gets the uniqueConstraint2 value for this OperationID.
     * 
     * @return uniqueConstraint2
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint2 getUniqueConstraint2() {
        return uniqueConstraint2;
    }


    /**
     * Sets the uniqueConstraint2 value for this OperationID.
     * 
     * @param uniqueConstraint2
     */
    public void setUniqueConstraint2(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.OperationUniqueConstraint2 uniqueConstraint2) {
        this.uniqueConstraint2 = uniqueConstraint2;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationID"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationUniqueConstraint1"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "OperationUniqueConstraint2"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
