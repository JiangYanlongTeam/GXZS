...
public class DistributionStatusUpdate  extends jsgx_mdm_business_partner.beans.ws.mdm.sap.com.DistributionStatusCreate  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.DistributionStatusID recordIdentification;
    ...
    public DistributionStatusUpdate(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.DistributionStatusID recordIdentification) {
        super(
            code,
            name);
     ...
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.DistributionStatusID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.DistributionStatusID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "DistributionStatusUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "DistributionStatusID"));
