...
public class ApprovalStatusQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusCriteria criteria;
    ...
    public ApprovalStatusQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusCriteria criteria,
     ...
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusCriteria getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusCriteria criteria) {
        this.criteria = criteria;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ApprovalStatusQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ApprovalStatusCriteria"));
