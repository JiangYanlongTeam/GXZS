/**
 * VendorAccountGroupsLookup.java
 *
...
public class VendorAccountGroupsLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public VendorAccountGroupsLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this VendorAccountGroupsLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this VendorAccountGroupsLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this VendorAccountGroupsLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this VendorAccountGroupsLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VendorAccountGroupsLookup)) return false;
        VendorAccountGroupsLookup other = (VendorAccountGroupsLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VendorAccountGroupsLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorAccountGroupsLookup"));
