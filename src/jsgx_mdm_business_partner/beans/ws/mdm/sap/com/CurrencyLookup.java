...
public class CurrencyLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this CurrencyLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CurrencyLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CurrencyLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CurrencyLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CurrencyLookup)) return false;
        CurrencyLookup other = (CurrencyLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CurrencyLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CurrencyLookup"));
