...
public class TradePartnersLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public TradePartnersLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this TradePartnersLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this TradePartnersLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this TradePartnersLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this TradePartnersLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TradePartnersLookup)) return false;
        TradePartnersLookup other = (TradePartnersLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TradePartnersLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "TradePartnersLookup"));
