...
public class CountriesUpdate  extends jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesCreate  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesID recordIdentification;
    ...
    public CountriesUpdate(
           ...
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesID recordIdentification) {
        super(
            code,
            name);
     ...
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CountriesUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CountriesID"));
