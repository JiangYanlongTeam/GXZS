...
public class CurrencyQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CurrencyCriteria criteria;
    ...
    public CurrencyQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CurrencyCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CurrencyQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CurrencyCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CurrencyQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CurrencyCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CurrencyQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CurrencyQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CurrencyQuery)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CurrencyQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CurrencyQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CurrencyCriteria"));
