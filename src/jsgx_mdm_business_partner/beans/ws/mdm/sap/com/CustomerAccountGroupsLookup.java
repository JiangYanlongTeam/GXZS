/**
 * CustomerAccountGroupsLookup.java
 *
...
public class CustomerAccountGroupsLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public CustomerAccountGroupsLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this CustomerAccountGroupsLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CustomerAccountGroupsLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CustomerAccountGroupsLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CustomerAccountGroupsLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomerAccountGroupsLookup)) return false;
        CustomerAccountGroupsLookup other = (CustomerAccountGroupsLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomerAccountGroupsLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerAccountGroupsLookup"));
