...
public class CustomerTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeCriteria criteria;
    ...
    public CustomerTypeQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CustomerTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CustomerTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomerTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CustomerTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CustomerTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomerTypeQuery)) return false;
        CustomerTypeQuery other = (CustomerTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomerTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerTypeCriteria"));
