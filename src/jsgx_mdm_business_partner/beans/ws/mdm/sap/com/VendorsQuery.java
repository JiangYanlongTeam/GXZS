...
public class VendorsQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCriteria criteria;
    ...
    public VendorsQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCriteria criteria,
    ...
    /**
     * Gets the criteria value for this VendorsQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this VendorsQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this VendorsQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this VendorsQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof VendorsQuery)) return false;
        VendorsQuery other = (VendorsQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VendorsQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsCriteria"));
