...
public class LanguagesQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.LanguagesCriteria criteria;
    ...
    public LanguagesQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.LanguagesCriteria criteria,
    ...
    /**
     * Gets the criteria value for this LanguagesQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.LanguagesCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this LanguagesQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.LanguagesCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this LanguagesQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this LanguagesQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LanguagesQuery)) return false;
        LanguagesQuery other = (LanguagesQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LanguagesQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "LanguagesQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "LanguagesCriteria"));
