...
public class CustomersQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomersCriteria criteria;
    ...
    public CustomersQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomersCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CustomersQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomersCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CustomersQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CustomersCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CustomersQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CustomersQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomersQuery)) return false;
        CustomersQuery other = (CustomersQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomersQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomersQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomersCriteria"));
