...
public class LanguagesLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this LanguagesLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this LanguagesLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this LanguagesLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this LanguagesLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LanguagesLookup)) return false;
        LanguagesLookup other = (LanguagesLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LanguagesLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "LanguagesLookup"));
