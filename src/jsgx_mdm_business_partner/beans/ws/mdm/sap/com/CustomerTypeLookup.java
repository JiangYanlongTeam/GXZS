...
public class CustomerTypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this CustomerTypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CustomerTypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CustomerTypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CustomerTypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomerTypeLookup)) return false;
        CustomerTypeLookup other = (CustomerTypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomerTypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CustomerTypeLookup"));
