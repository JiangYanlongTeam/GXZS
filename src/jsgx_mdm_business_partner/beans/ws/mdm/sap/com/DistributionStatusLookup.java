...
public class DistributionStatusLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public DistributionStatusLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this DistributionStatusLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this DistributionStatusLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this DistributionStatusLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this DistributionStatusLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DistributionStatusLookup)) return false;
        DistributionStatusLookup other = (DistributionStatusLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DistributionStatusLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "DistributionStatusLookup"));
