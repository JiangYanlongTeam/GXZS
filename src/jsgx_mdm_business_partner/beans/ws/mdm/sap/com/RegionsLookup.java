...
public class RegionsLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public RegionsLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this RegionsLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this RegionsLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this RegionsLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this RegionsLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegionsLookup)) return false;
        RegionsLookup other = (RegionsLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegionsLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "RegionsLookup"));
