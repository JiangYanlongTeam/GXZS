...
public class ClientSystemsLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public ClientSystemsLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this ClientSystemsLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this ClientSystemsLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this ClientSystemsLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this ClientSystemsLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClientSystemsLookup)) return false;
        ClientSystemsLookup other = (ClientSystemsLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClientSystemsLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ClientSystemsLookup"));
