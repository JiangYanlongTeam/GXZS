...
public class CountriesQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesCriteria criteria;
    ...
    public CountriesQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CountriesQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CountriesQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.CountriesCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CountriesQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CountriesQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CountriesQuery)) return false;
        CountriesQuery other = (CountriesQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CountriesQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CountriesQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "CountriesCriteria"));
