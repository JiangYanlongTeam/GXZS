...
public class RegionsQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.RegionsCriteria criteria;
    ...
    public RegionsQuery(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.RegionsCriteria criteria,
    ...
    /**
     * Gets the criteria value for this RegionsQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.RegionsCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this RegionsQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.RegionsCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this RegionsQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this RegionsQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegionsQuery)) return false;
        RegionsQuery other = (RegionsQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegionsQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "RegionsQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "RegionsCriteria"));
