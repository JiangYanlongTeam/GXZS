/**
 * SI_1104_ALL2ERP_FPJY_OUTServiceLocator.java
 *
...
public class SI_1104_ALL2ERP_FPJY_OUTServiceLocator extends org.apache.axis.client.Service implements SI_1104_ALL2ERP_FPJY_OUTService {

    public SI_1104_ALL2ERP_FPJY_OUTServiceLocator() {
    }


    public SI_1104_ALL2ERP_FPJY_OUTServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public SI_1104_ALL2ERP_FPJY_OUTServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public SI_1104_ALL2ERP_FPJY_OUT getHTTPS_Port() throws javax.xml.rpc.ServiceException {
    ...
    public SI_1104_ALL2ERP_FPJY_OUT getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SI_1104_ALL2ERP_FPJY_OUTBindingStub _stub = new SI_1104_ALL2ERP_FPJY_OUTBindingStub(portAddress, this);
    ...
    public SI_1104_ALL2ERP_FPJY_OUT getHTTP_Port() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public SI_1104_ALL2ERP_FPJY_OUT getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SI_1104_ALL2ERP_FPJY_OUTBindingStub _stub = new SI_1104_ALL2ERP_FPJY_OUTBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SI_1104_ALL2ERP_FPJY_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                SI_1104_ALL2ERP_FPJY_OUTBindingStub _stub = new SI_1104_ALL2ERP_FPJY_OUTBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (SI_1104_ALL2ERP_FPJY_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                SI_1104_ALL2ERP_FPJY_OUTBindingStub _stub = new SI_1104_ALL2ERP_FPJY_OUTBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.jsgx.net/E1D/service", "SI_1104_ALL2ERP_FPJY_OUTService");
    }
