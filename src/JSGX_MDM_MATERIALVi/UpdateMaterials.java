...
public class UpdateMaterials  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsUpdate[] materials;
    ...
    public UpdateMaterials(
           jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsUpdate[] materials,
    ...
    /**
     * Gets the materials value for this UpdateMaterials.
     * 
     * @return materials
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsUpdate[] getMaterials() {
        return materials;
    }


    /**
     * Sets the materials value for this UpdateMaterials.
     * 
     * @param materials
     */
    public void setMaterials(jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsUpdate[] materials) {
        this.materials = materials;
    }


    /**
     * Gets the reposInfo value for this UpdateMaterials.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this UpdateMaterials.
     * 
     * @param reposInfo
     */
    ...
    /**
     * Gets the configurationParameters value for this UpdateMaterials.
     * 
    ...
    /**
     * Sets the configurationParameters value for this UpdateMaterials.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateMaterials)) return false;
        UpdateMaterials other = (UpdateMaterials) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateMaterials.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", ">updateMaterials"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("materials");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", "Materials"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsUpdate"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsUpdate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", "configurationParameters"));
