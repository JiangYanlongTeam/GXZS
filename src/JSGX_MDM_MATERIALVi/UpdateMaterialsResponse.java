...
public class UpdateMaterialsResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public UpdateMaterialsResponse() {
    }
    ...
    /**
     * Gets the response value for this UpdateMaterialsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateMaterialsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateMaterialsResponse)) return false;
        UpdateMaterialsResponse other = (UpdateMaterialsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateMaterialsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", ">updateMaterialsResponse"));
