...
public class SearchOperation  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.OperationQuery query;
    ...
    public SearchOperation(
           jsgx_mdm_material.beans.ws.mdm.sap.com.OperationQuery query,
     ...
     * @return query
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.OperationQuery getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(jsgx_mdm_material.beans.ws.mdm.sap.com.OperationQuery query) {
        this.query = query;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", ">searchOperation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("query");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", "query"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "OperationQuery"));
