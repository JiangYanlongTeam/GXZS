...
public class CreateMaterialsResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public CreateMaterialsResponse() {
    }
    ...
    /**
     * Gets the response value for this CreateMaterialsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateMaterialsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateMaterialsResponse)) return false;
        CreateMaterialsResponse other = (CreateMaterialsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateMaterialsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", ">createMaterialsResponse"));
