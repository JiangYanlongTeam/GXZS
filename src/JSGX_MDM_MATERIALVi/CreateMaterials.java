...
public class CreateMaterials  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCreate[] materials;
    ...
    public CreateMaterials(
           jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCreate[] materials,
    ...
    /**
     * Gets the materials value for this CreateMaterials.
     * 
     * @return materials
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCreate[] getMaterials() {
        return materials;
    }


    /**
     * Sets the materials value for this CreateMaterials.
     * 
     * @param materials
     */
    public void setMaterials(jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCreate[] materials) {
        this.materials = materials;
    }


    /**
     * Gets the reposInfo value for this CreateMaterials.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this CreateMaterials.
     * 
     * @param reposInfo
     */
    ...
    /**
     * Gets the configurationParameters value for this CreateMaterials.
     * 
    ...
    /**
     * Sets the configurationParameters value for this CreateMaterials.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateMaterials)) return false;
        CreateMaterials other = (CreateMaterials) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateMaterials.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_MATERIALVi", ">createMaterials"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsCreate"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsCreate"));
