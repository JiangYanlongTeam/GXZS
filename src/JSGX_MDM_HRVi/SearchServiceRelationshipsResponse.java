...
public class SearchServiceRelationshipsResponse  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationshipsResultSet response;

    public SearchServiceRelationshipsResponse() {
    }

    public SearchServiceRelationshipsResponse(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationshipsResultSet response) {
     ...
     * @return response
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationshipsResultSet getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationshipsResultSet response) {
        this.response = response;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", ">searchServiceRelationshipsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("response");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", "Response"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ServiceRelationshipsResultSet"));
