...
public class SearchEmployee  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeQuery query;
    ...
    public SearchEmployee(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeQuery query,
    ...
    /**
     * Gets the query value for this SearchEmployee.
     * 
     * @return query
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeQuery getQuery() {
        return query;
    }


    /**
     * Sets the query value for this SearchEmployee.
     * 
     * @param query
     */
    public void setQuery(jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeQuery query) {
        this.query = query;
    }


    /**
     * Gets the reposInfo value for this SearchEmployee.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this SearchEmployee.
     * 
     * @param reposInfo
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", ">searchEmployee"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("query");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", "query"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeQuery"));
