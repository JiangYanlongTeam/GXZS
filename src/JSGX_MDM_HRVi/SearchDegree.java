...
public class SearchDegree  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeQuery query;
    ...
    public SearchDegree(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeQuery query,
    ...
    /**
     * Gets the query value for this SearchDegree.
     * 
     * @return query
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeQuery getQuery() {
        return query;
    }


    /**
     * Sets the query value for this SearchDegree.
     * 
     * @param query
     */
    public void setQuery(jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeQuery query) {
        this.query = query;
    }


    /**
     * Gets the reposInfo value for this SearchDegree.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this SearchDegree.
     * 
     * @param reposInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SearchDegree)) return false;
        SearchDegree other = (SearchDegree) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SearchDegree.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", ">searchDegree"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("query");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_HRVi", "query"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "DegreeQuery"));
