...
public class CreateVendors  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCreate[] vendors;
    ...
    public CreateVendors(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCreate[] vendors,
    ...
    /**
     * Gets the vendors value for this CreateVendors.
     * 
     * @return vendors
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCreate[] getVendors() {
        return vendors;
    }


    /**
     * Sets the vendors value for this CreateVendors.
     * 
     * @param vendors
     */
    public void setVendors(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsCreate[] vendors) {
        this.vendors = vendors;
    }


    /**
     * Gets the reposInfo value for this CreateVendors.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this CreateVendors.
     * 
     * @param reposInfo
     */
    ...
    /**
     * Gets the configurationParameters value for this CreateVendors.
     * 
    ...
    /**
     * Sets the configurationParameters value for this CreateVendors.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateVendors)) return false;
        CreateVendors other = (CreateVendors) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateVendors.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">createVendors"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("vendors");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", "vendors"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsCreate"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsCreate"));
