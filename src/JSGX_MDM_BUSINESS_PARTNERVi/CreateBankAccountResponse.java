/**
 * CreateBankAccountResponse.java
 *
...
public class CreateBankAccountResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the response value for this CreateBankAccountResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateBankAccountResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateBankAccountResponse)) return false;
        CreateBankAccountResponse other = (CreateBankAccountResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateBankAccountResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">createBankAccountResponse"));
