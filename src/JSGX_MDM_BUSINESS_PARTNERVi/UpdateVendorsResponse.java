...
public class UpdateVendorsResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public UpdateVendorsResponse() {
    }
    ...
    /**
     * Gets the response value for this UpdateVendorsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateVendorsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateVendorsResponse)) return false;
        UpdateVendorsResponse other = (UpdateVendorsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateVendorsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">updateVendorsResponse"));
