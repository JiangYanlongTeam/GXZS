...
public class CreateBanksResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public CreateBanksResponse() {
    }
    ...
    /**
     * Gets the response value for this CreateBanksResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateBanksResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateBanksResponse)) return false;
        CreateBanksResponse other = (CreateBanksResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateBanksResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">createBanksResponse"));
