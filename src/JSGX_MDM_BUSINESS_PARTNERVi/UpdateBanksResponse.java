...
public class UpdateBanksResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public UpdateBanksResponse() {
    }
    ...
    /**
     * Gets the response value for this UpdateBanksResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateBanksResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateBanksResponse)) return false;
        UpdateBanksResponse other = (UpdateBanksResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateBanksResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">updateBanksResponse"));
