...
public class CreateCustomersResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public CreateCustomersResponse() {
    }
    ...
    /**
     * Gets the response value for this CreateCustomersResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateCustomersResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCustomersResponse)) return false;
        CreateCustomersResponse other = (CreateCustomersResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCustomersResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">createCustomersResponse"));
