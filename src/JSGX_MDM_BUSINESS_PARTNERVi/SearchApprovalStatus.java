...
public class SearchApprovalStatus  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusQuery query;
    ...
    public SearchApprovalStatus(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusQuery query,
     ...
     * @return query
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusQuery getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.ApprovalStatusQuery query) {
        this.query = query;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">searchApprovalStatus"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("query");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", "query"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "ApprovalStatusQuery"));
