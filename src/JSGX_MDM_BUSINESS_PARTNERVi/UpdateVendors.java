...
public class UpdateVendors  implements java.io.Serializable {
    private jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsUpdate[] vendors;
    ...
    public UpdateVendors(
           jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsUpdate[] vendors,
    ...
    /**
     * Gets the vendors value for this UpdateVendors.
     * 
     * @return vendors
     */
    public jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsUpdate[] getVendors() {
        return vendors;
    }


    /**
     * Sets the vendors value for this UpdateVendors.
     * 
     * @param vendors
     */
    public void setVendors(jsgx_mdm_business_partner.beans.ws.mdm.sap.com.VendorsUpdate[] vendors) {
        this.vendors = vendors;
    }


    /**
     * Gets the reposInfo value for this UpdateVendors.
     * 
     * @return reposInfo
     */
    ...
    /**
     * Sets the reposInfo value for this UpdateVendors.
     * 
     * @param reposInfo
     */
    ...
    /**
     * Gets the configurationParameters value for this UpdateVendors.
     * 
    ...
    /**
     * Sets the configurationParameters value for this UpdateVendors.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateVendors)) return false;
        UpdateVendors other = (UpdateVendors) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateVendors.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">updateVendors"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsUpdate"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_business_partner", "VendorsUpdate"));
