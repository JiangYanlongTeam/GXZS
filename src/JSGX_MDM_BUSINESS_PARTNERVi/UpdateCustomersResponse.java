...
public class UpdateCustomersResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the response value for this UpdateCustomersResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateCustomersResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateCustomersResponse)) return false;
        UpdateCustomersResponse other = (UpdateCustomersResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateCustomersResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">updateCustomersResponse"));
