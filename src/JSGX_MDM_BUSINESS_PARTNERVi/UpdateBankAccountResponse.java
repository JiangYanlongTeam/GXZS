/**
 * UpdateBankAccountResponse.java
 *
...
public class UpdateBankAccountResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the response value for this UpdateBankAccountResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateBankAccountResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateBankAccountResponse)) return false;
        UpdateBankAccountResponse other = (UpdateBankAccountResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateBankAccountResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">updateBankAccountResponse"));
