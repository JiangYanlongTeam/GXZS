...
public class CreateVendorsResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public CreateVendorsResponse() {
    }
    ...
    /**
     * Gets the response value for this CreateVendorsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateVendorsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateVendorsResponse)) return false;
        CreateVendorsResponse other = (CreateVendorsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateVendorsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_BUSINESS_PARTNERVi", ">createVendorsResponse"));
