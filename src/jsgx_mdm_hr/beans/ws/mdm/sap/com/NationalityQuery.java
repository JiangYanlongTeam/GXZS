...
public class NationalityQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.NationalityCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public NationalityQuery() {
    }

    public NationalityQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.NationalityCriteria criteria,
    ...
    /**
     * Gets the criteria value for this NationalityQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.NationalityCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this NationalityQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.NationalityCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this NationalityQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this NationalityQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NationalityQuery)) return false;
        NationalityQuery other = (NationalityQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NationalityQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "NationalityQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "NationalityCriteria"));
