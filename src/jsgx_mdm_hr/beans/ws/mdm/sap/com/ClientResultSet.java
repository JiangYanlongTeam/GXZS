...
public class ClientResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.Client[] client;
    ...
    public ClientResultSet(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.Client[] client) {
        super(
            executionStatus);
        this.client = client;
    }
     ...
     * @return client
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.Client[] getClient() {
        return client;
    }
     ...
     * @param client
     */
    public void setClient(jsgx_mdm_hr.beans.ws.mdm.sap.com.Client[] client) {
        this.client = client;
    }

    public jsgx_mdm_hr.beans.ws.mdm.sap.com.Client getClient(int i) {
        return this.client[i];
    }

    public void setClient(int i, jsgx_mdm_hr.beans.ws.mdm.sap.com.Client _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ClientResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("client");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "client"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "Client"));
