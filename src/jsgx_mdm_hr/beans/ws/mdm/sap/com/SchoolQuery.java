...
public class SchoolQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolCriteria criteria;
    ...
    public SchoolQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolCriteria criteria,
    ...
    /**
     * Gets the criteria value for this SchoolQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this SchoolQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this SchoolQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this SchoolQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SchoolQuery)) return false;
        SchoolQuery other = (SchoolQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SchoolQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "SchoolQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "SchoolCriteria"));
