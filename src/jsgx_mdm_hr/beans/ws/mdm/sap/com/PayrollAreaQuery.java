...
public class PayrollAreaQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.PayrollAreaCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public PayrollAreaQuery() {
    }

    public PayrollAreaQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.PayrollAreaCriteria criteria,
    ...
    /**
     * Gets the criteria value for this PayrollAreaQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.PayrollAreaCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this PayrollAreaQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.PayrollAreaCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this PayrollAreaQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this PayrollAreaQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PayrollAreaQuery)) return false;
        PayrollAreaQuery other = (PayrollAreaQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PayrollAreaQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "PayrollAreaQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "PayrollAreaCriteria"));
