...
public class SchoolTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolTypeCriteria criteria;
    ...
    public SchoolTypeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this SchoolTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this SchoolTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.SchoolTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this SchoolTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this SchoolTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SchoolTypeQuery)) return false;
        SchoolTypeQuery other = (SchoolTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SchoolTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "SchoolTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "SchoolTypeCriteria"));
