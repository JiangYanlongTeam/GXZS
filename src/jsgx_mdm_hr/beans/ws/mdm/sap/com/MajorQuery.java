...
public class MajorQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.MajorCriteria criteria;
    ...
    public MajorQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.MajorCriteria criteria,
    ...
    /**
     * Gets the criteria value for this MajorQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.MajorCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this MajorQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.MajorCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this MajorQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this MajorQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MajorQuery)) return false;
        MajorQuery other = (MajorQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MajorQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "MajorQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "MajorCriteria"));
