...
public class ProductsCriteria  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private beans.ws.mdm.sap.com.PicklistCriteria category;

    private beans.ws.mdm.sap.com.AttributeCriteria[] categoryAttributeCriteria;
    ...
    public ProductsCriteria(
           ...
           beans.ws.mdm.sap.com.PicklistCriteria category,
           beans.ws.mdm.sap.com.AttributeCriteria[] categoryAttributeCriteria) {
        ...
        this.categoryAttributeCriteria = categoryAttributeCriteria;
    }


    /**
     * Gets the namedSearchCriteria value for this ProductsCriteria.
     * 
    ...
    /**
     * Sets the namedSearchCriteria value for this ProductsCriteria.
     * 
    ...
    /**
     * Gets the maskCriteria value for this ProductsCriteria.
     * 
     * @return maskCriteria
     */
    ...
    /**
     * Sets the maskCriteria value for this ProductsCriteria.
     * 
     * @param maskCriteria
     */
    ...
    /**
     * Gets the logicalOperator value for this ProductsCriteria.
     * 
    ...
    /**
     * Sets the logicalOperator value for this ProductsCriteria.
     * 
    ...
    /**
     * Gets the keywordCriteria value for this ProductsCriteria.
     * 
    ...
    /**
     * Sets the keywordCriteria value for this ProductsCriteria.
     * 
    ...
    /**
     * Gets the name value for this ProductsCriteria.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this ProductsCriteria.
     * 
     * @param name
     */
    ...
    /**
     * Gets the category value for this ProductsCriteria.
     * 
     * @return category
     */
    public beans.ws.mdm.sap.com.PicklistCriteria getCategory() {
        return category;
    }


    /**
     * Sets the category value for this ProductsCriteria.
     * 
     * @param category
     */
    public void setCategory(beans.ws.mdm.sap.com.PicklistCriteria category) {
        this.category = category;
    }


    /**
     * Gets the categoryAttributeCriteria value for this ProductsCriteria.
     * 
     * @return categoryAttributeCriteria
     */
    public beans.ws.mdm.sap.com.AttributeCriteria[] getCategoryAttributeCriteria() {
        return categoryAttributeCriteria;
    }


    /**
     * Sets the categoryAttributeCriteria value for this ProductsCriteria.
     * 
     * @param categoryAttributeCriteria
     */
    public void setCategoryAttributeCriteria(beans.ws.mdm.sap.com.AttributeCriteria[] categoryAttributeCriteria) {
        this.categoryAttributeCriteria = categoryAttributeCriteria;
    }

    public beans.ws.mdm.sap.com.AttributeCriteria getCategoryAttributeCriteria(int i) {
        return this.categoryAttributeCriteria[i];
    }

    public void setCategoryAttributeCriteria(int i, beans.ws.mdm.sap.com.AttributeCriteria _value) {
        this.categoryAttributeCriteria[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProductsCriteria)) return false;
        ProductsCriteria other = (ProductsCriteria) obj;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.categoryAttributeCriteria==null && other.getCategoryAttributeCriteria()==null) || 
             (this.categoryAttributeCriteria!=null &&
              java.util.Arrays.equals(this.categoryAttributeCriteria, other.getCategoryAttributeCriteria())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCategoryAttributeCriteria() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCategoryAttributeCriteria());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCategoryAttributeCriteria(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProductsCriteria.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsCriteria"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "category"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans", "PicklistCriteria"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("categoryAttributeCriteria");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "categoryAttributeCriteria"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans", "AttributeCriteria"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
