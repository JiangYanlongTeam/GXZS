...
public class ProductsID  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsDisplayFields displayFields;
    ...
    public ProductsID(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsDisplayFields displayFields) {
     ...
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsDisplayFields getDisplayFields() {
        return displayFields;
    }
     ...
     * @param displayFields
     */
    public void setDisplayFields(jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsDisplayFields displayFields) {
        this.displayFields = displayFields;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsID"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsDisplayFields"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
