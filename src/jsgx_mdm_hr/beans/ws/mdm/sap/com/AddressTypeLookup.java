...
public class AddressTypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this AddressTypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this AddressTypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this AddressTypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this AddressTypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddressTypeLookup)) return false;
        AddressTypeLookup other = (AddressTypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddressTypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "AddressTypeLookup"));
