...
public class EmployeeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeCriteria criteria;
    ...
    public EmployeeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this EmployeeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this EmployeeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this EmployeeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this EmployeeQuery.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeCriteria"));
