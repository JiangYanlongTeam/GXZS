...
public class ProductsUpdate  extends jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsCreate  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsID recordIdentification;
    ...
    public ProductsUpdate(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.CategoriesLookup category,
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsID recordIdentification) {
        super(
            name,
            category);
     ...
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_hr.beans.ws.mdm.sap.com.ProductsID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsID"));
