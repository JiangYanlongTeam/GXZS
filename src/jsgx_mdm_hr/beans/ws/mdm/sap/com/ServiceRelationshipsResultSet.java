...
public class ServiceRelationshipsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships;
    ...
    public ServiceRelationshipsResultSet(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships) {
        super(
            executionStatus);
     ...
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships[] getServiceRelationships() {
        return serviceRelationships;
    }
     ...
     */
    public void setServiceRelationships(jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships) {
        this.serviceRelationships = serviceRelationships;
    }

    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships getServiceRelationships(int i) {
        return this.serviceRelationships[i];
    }

    public void setServiceRelationships(int i, jsgx_mdm_hr.beans.ws.mdm.sap.com.ServiceRelationships _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ServiceRelationshipsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("serviceRelationships");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "serviceRelationships"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ServiceRelationships"));
