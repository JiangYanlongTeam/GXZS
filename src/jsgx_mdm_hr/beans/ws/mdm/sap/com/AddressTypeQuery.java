...
public class AddressTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.AddressTypeCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public AddressTypeQuery() {
    }

    public AddressTypeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.AddressTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this AddressTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.AddressTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this AddressTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.AddressTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this AddressTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this AddressTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddressTypeQuery)) return false;
        AddressTypeQuery other = (AddressTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddressTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "AddressTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "AddressTypeCriteria"));
