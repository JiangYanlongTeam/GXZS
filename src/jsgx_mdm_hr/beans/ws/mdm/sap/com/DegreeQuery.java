...
public class DegreeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeCriteria criteria;
    ...
    public DegreeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this DegreeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this DegreeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.DegreeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this DegreeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this DegreeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DegreeQuery)) return false;
        DegreeQuery other = (DegreeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DegreeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "DegreeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "DegreeCriteria"));
