...
public class ID_TypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public ID_TypeLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this ID_TypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this ID_TypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this ID_TypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this ID_TypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID_TypeLookup)) return false;
        ID_TypeLookup other = (ID_TypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID_TypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ID_TypeLookup"));
