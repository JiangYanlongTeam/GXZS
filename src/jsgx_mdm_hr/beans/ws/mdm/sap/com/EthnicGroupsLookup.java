...
public class EthnicGroupsLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public EthnicGroupsLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this EthnicGroupsLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this EthnicGroupsLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this EthnicGroupsLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this EthnicGroupsLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EthnicGroupsLookup)) return false;
        EthnicGroupsLookup other = (EthnicGroupsLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EthnicGroupsLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EthnicGroupsLookup"));
