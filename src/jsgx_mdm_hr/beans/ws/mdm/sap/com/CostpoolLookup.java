...
public class CostpoolLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public CostpoolLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this CostpoolLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CostpoolLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CostpoolLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CostpoolLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CostpoolLookup)) return false;
        CostpoolLookup other = (CostpoolLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CostpoolLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "CostpoolLookup"));
