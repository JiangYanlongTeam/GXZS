...
public class PayrollAreaLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public PayrollAreaLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this PayrollAreaLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this PayrollAreaLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this PayrollAreaLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this PayrollAreaLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PayrollAreaLookup)) return false;
        PayrollAreaLookup other = (PayrollAreaLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PayrollAreaLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "PayrollAreaLookup"));
