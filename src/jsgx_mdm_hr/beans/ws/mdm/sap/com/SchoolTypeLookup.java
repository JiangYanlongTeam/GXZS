...
public class SchoolTypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public SchoolTypeLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this SchoolTypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this SchoolTypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this SchoolTypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this SchoolTypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SchoolTypeLookup)) return false;
        SchoolTypeLookup other = (SchoolTypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SchoolTypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "SchoolTypeLookup"));
