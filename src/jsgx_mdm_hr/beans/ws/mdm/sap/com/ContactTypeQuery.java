...
public class ContactTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ContactTypeCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public ContactTypeQuery() {
    }

    public ContactTypeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ContactTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this ContactTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ContactTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this ContactTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.ContactTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this ContactTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this ContactTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactTypeQuery)) return false;
        ContactTypeQuery other = (ContactTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ContactTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ContactTypeCriteria"));
