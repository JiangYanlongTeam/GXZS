...
public class IndustryQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.IndustryCriteria criteria;
    ...
    public IndustryQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.IndustryCriteria criteria,
    ...
    /**
     * Gets the criteria value for this IndustryQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.IndustryCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this IndustryQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.IndustryCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this IndustryQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this IndustryQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IndustryQuery)) return false;
        IndustryQuery other = (IndustryQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IndustryQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "IndustryQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "IndustryCriteria"));
