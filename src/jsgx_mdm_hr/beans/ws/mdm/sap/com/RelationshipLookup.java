...
public class RelationshipLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public RelationshipLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this RelationshipLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this RelationshipLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this RelationshipLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this RelationshipLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelationshipLookup)) return false;
        RelationshipLookup other = (RelationshipLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RelationshipLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "RelationshipLookup"));
