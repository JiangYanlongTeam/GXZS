...
public class IndustryLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public IndustryLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this IndustryLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this IndustryLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this IndustryLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this IndustryLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IndustryLookup)) return false;
        IndustryLookup other = (IndustryLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IndustryLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "IndustryLookup"));
