...
public class LanguageLevelLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public LanguageLevelLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this LanguageLevelLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this LanguageLevelLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this LanguageLevelLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this LanguageLevelLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LanguageLevelLookup)) return false;
        LanguageLevelLookup other = (LanguageLevelLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LanguageLevelLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "LanguageLevelLookup"));
