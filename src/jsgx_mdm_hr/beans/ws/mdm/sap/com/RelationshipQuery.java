...
public class RelationshipQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.RelationshipCriteria criteria;
    ...
    public RelationshipQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.RelationshipCriteria criteria,
    ...
    /**
     * Gets the criteria value for this RelationshipQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.RelationshipCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this RelationshipQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.RelationshipCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this RelationshipQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this RelationshipQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelationshipQuery)) return false;
        RelationshipQuery other = (RelationshipQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RelationshipQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "RelationshipQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "RelationshipCriteria"));
