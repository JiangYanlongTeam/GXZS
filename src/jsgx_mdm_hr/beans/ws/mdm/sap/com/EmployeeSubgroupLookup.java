...
public class EmployeeSubgroupLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public EmployeeSubgroupLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this EmployeeSubgroupLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this EmployeeSubgroupLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this EmployeeSubgroupLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this EmployeeSubgroupLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EmployeeSubgroupLookup)) return false;
        EmployeeSubgroupLookup other = (EmployeeSubgroupLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EmployeeSubgroupLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeSubgroupLookup"));
