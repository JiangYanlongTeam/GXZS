...
public class EmployeeID  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeUniqueConstraint1 uniqueConstraint1;
    ...
    public EmployeeID(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeUniqueConstraint1 uniqueConstraint1) {
    ...
    /**
     * Gets the internalID value for this EmployeeID.
     * 
     * @return internalID
     */
    ...
    /**
     * Sets the internalID value for this EmployeeID.
     * 
     * @param internalID
     */
    ...
    /**
     * Gets the keyMapping value for this EmployeeID.
     * 
     * @return keyMapping
     */
    ...
    /**
     * Sets the keyMapping value for this EmployeeID.
     * 
     * @param keyMapping
     */
    ...
    /**
     * Gets the autoID value for this EmployeeID.
     * 
     * @return autoID
     */
    ...
    /**
     * Sets the autoID value for this EmployeeID.
     * 
     * @param autoID
     */
    ...
    /**
     * Gets the uniqueConstraint1 value for this EmployeeID.
     * 
     * @return uniqueConstraint1
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeUniqueConstraint1 getUniqueConstraint1() {
        return uniqueConstraint1;
    }


    /**
     * Sets the uniqueConstraint1 value for this EmployeeID.
     * 
     * @param uniqueConstraint1
     */
    public void setUniqueConstraint1(jsgx_mdm_hr.beans.ws.mdm.sap.com.EmployeeUniqueConstraint1 uniqueConstraint1) {
        this.uniqueConstraint1 = uniqueConstraint1;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EmployeeID.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeID"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeUniqueConstraint1"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
