...
public class DistributionStatusUpdate  extends jsgx_mdm_hr.beans.ws.mdm.sap.com.DistributionStatusCreate  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.DistributionStatusID recordIdentification;
     ...
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.DistributionStatusID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_hr.beans.ws.mdm.sap.com.DistributionStatusID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "DistributionStatusUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "DistributionStatusID"));
