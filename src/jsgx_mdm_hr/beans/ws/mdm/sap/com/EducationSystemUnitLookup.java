/**
 * EducationSystemUnitLookup.java
 *
...
public class EducationSystemUnitLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public EducationSystemUnitLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this EducationSystemUnitLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this EducationSystemUnitLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this EducationSystemUnitLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this EducationSystemUnitLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EducationSystemUnitLookup)) return false;
        EducationSystemUnitLookup other = (EducationSystemUnitLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EducationSystemUnitLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EducationSystemUnitLookup"));
