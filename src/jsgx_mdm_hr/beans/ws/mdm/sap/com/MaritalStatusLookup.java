...
public class MaritalStatusLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this MaritalStatusLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this MaritalStatusLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this MaritalStatusLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this MaritalStatusLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MaritalStatusLookup)) return false;
        MaritalStatusLookup other = (MaritalStatusLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MaritalStatusLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "MaritalStatusLookup"));
