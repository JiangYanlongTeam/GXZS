...
public class EmployeeGroupLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public EmployeeGroupLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this EmployeeGroupLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this EmployeeGroupLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this EmployeeGroupLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this EmployeeGroupLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EmployeeGroupLookup)) return false;
        EmployeeGroupLookup other = (EmployeeGroupLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EmployeeGroupLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "EmployeeGroupLookup"));
