...
public class WorkTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.WorkTypeCriteria criteria;
    ...
    public WorkTypeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.WorkTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this WorkTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.WorkTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this WorkTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.WorkTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this WorkTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this WorkTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkTypeQuery)) return false;
        WorkTypeQuery other = (WorkTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WorkTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "WorkTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "WorkTypeCriteria"));
