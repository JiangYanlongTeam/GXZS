...
public class LearningFormLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public LearningFormLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this LearningFormLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this LearningFormLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this LearningFormLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this LearningFormLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LearningFormLookup)) return false;
        LearningFormLookup other = (LearningFormLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LearningFormLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "LearningFormLookup"));
