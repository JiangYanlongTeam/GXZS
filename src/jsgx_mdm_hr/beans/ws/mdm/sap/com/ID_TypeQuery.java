...
public class ID_TypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ID_TypeCriteria criteria;
    ...
    public ID_TypeQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ID_TypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this ID_TypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ID_TypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this ID_TypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.ID_TypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this ID_TypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this ID_TypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ID_TypeQuery)) return false;
        ID_TypeQuery other = (ID_TypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ID_TypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ID_TypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ID_TypeCriteria"));
