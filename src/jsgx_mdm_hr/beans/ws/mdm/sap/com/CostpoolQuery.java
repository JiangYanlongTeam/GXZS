...
public class CostpoolQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.CostpoolCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public CostpoolQuery() {
    }

    public CostpoolQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.CostpoolCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CostpoolQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.CostpoolCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CostpoolQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.CostpoolCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CostpoolQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CostpoolQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CostpoolQuery)) return false;
        CostpoolQuery other = (CostpoolQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CostpoolQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "CostpoolQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "CostpoolCriteria"));
