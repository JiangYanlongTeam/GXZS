...
public class PersonnelSubareasLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public PersonnelSubareasLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this PersonnelSubareasLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this PersonnelSubareasLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this PersonnelSubareasLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this PersonnelSubareasLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PersonnelSubareasLookup)) return false;
        PersonnelSubareasLookup other = (PersonnelSubareasLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PersonnelSubareasLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "PersonnelSubareasLookup"));
