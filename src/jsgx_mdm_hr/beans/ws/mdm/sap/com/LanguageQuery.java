...
public class LanguageQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.LanguageCriteria criteria;
    ...
    public LanguageQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.LanguageCriteria criteria,
    ...
    /**
     * Gets the criteria value for this LanguageQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.LanguageCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this LanguageQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.LanguageCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this LanguageQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this LanguageQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LanguageQuery)) return false;
        LanguageQuery other = (LanguageQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LanguageQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "LanguageQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "LanguageCriteria"));
