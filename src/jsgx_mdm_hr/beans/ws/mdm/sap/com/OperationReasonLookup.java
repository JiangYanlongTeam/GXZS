...
public class OperationReasonLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public OperationReasonLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this OperationReasonLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this OperationReasonLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this OperationReasonLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this OperationReasonLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationReasonLookup)) return false;
        OperationReasonLookup other = (OperationReasonLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OperationReasonLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "OperationReasonLookup"));
