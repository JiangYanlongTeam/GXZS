...
public class ProductsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.Products[] products;
    ...
    public ProductsResultSet(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.Products[] products) {
        super(
            executionStatus);
     ...
     * @return products
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.Products[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(jsgx_mdm_hr.beans.ws.mdm.sap.com.Products[] products) {
        this.products = products;
    }

    public jsgx_mdm_hr.beans.ws.mdm.sap.com.Products getProducts(int i) {
        return this.products[i];
    }

    public void setProducts(int i, jsgx_mdm_hr.beans.ws.mdm.sap.com.Products _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ProductsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("products");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "products"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "Products"));
