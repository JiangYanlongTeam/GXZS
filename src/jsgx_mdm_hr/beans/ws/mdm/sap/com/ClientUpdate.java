...
public class ClientUpdate  extends jsgx_mdm_hr.beans.ws.mdm.sap.com.ClientCreate  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.ClientID recordIdentification;
    ...
    public ClientUpdate(
           ...
           jsgx_mdm_hr.beans.ws.mdm.sap.com.ClientID recordIdentification) {
        super(
            code,
            name);
     ...
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.ClientID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(jsgx_mdm_hr.beans.ws.mdm.sap.com.ClientID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ClientUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "ClientID"));
