...
public class PersonnelAreaLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public PersonnelAreaLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this PersonnelAreaLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this PersonnelAreaLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this PersonnelAreaLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this PersonnelAreaLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PersonnelAreaLookup)) return false;
        PersonnelAreaLookup other = (PersonnelAreaLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PersonnelAreaLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "PersonnelAreaLookup"));
