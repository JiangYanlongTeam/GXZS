...
public class JobPositionQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.JobPositionCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public JobPositionQuery() {
    }

    public JobPositionQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.JobPositionCriteria criteria,
    ...
    /**
     * Gets the criteria value for this JobPositionQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.JobPositionCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this JobPositionQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.JobPositionCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this JobPositionQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this JobPositionQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof JobPositionQuery)) return false;
        JobPositionQuery other = (JobPositionQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(JobPositionQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "JobPositionQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "JobPositionCriteria"));
