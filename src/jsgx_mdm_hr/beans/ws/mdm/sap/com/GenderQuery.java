...
public class GenderQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.GenderCriteria criteria;
    ...
    public GenderQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.GenderCriteria criteria,
    ...
    /**
     * Gets the criteria value for this GenderQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.GenderCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this GenderQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.GenderCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this GenderQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this GenderQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GenderQuery)) return false;
        GenderQuery other = (GenderQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GenderQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "GenderQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "GenderCriteria"));
