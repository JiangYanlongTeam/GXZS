...
public class IncidentQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_hr.beans.ws.mdm.sap.com.IncidentCriteria criteria;
    ...
    public IncidentQuery(
           jsgx_mdm_hr.beans.ws.mdm.sap.com.IncidentCriteria criteria,
    ...
    /**
     * Gets the criteria value for this IncidentQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_hr.beans.ws.mdm.sap.com.IncidentCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this IncidentQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_hr.beans.ws.mdm.sap.com.IncidentCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this IncidentQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this IncidentQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IncidentQuery)) return false;
        IncidentQuery other = (IncidentQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IncidentQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "IncidentQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_hr", "IncidentCriteria"));
