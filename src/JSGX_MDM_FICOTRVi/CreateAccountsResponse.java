...
public class CreateAccountsResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the response value for this CreateAccountsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateAccountsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateAccountsResponse)) return false;
        CreateAccountsResponse other = (CreateAccountsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateAccountsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_FICOTRVi", ">createAccountsResponse"));
