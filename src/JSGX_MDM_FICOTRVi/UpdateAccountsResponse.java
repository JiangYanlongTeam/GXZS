...
public class UpdateAccountsResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the response value for this UpdateAccountsResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateAccountsResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateAccountsResponse)) return false;
        UpdateAccountsResponse other = (UpdateAccountsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateAccountsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_FICOTRVi", ">updateAccountsResponse"));
