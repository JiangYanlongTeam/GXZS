/**
 * CreateCommitmentltemResponse.java
 *
...
public class CreateCommitmentltemResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public CreateCommitmentltemResponse() {
    }
    ...
    /**
     * Gets the response value for this CreateCommitmentltemResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this CreateCommitmentltemResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCommitmentltemResponse)) return false;
        CreateCommitmentltemResponse other = (CreateCommitmentltemResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCommitmentltemResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_FICOTRVi", ">createCommitmentltemResponse"));
