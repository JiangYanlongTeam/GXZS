/**
 * UpdateCommitmentltemResponse.java
 *
...
public class UpdateCommitmentltemResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public UpdateCommitmentltemResponse() {
    }
    ...
    /**
     * Gets the response value for this UpdateCommitmentltemResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateCommitmentltemResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateCommitmentltemResponse)) return false;
        UpdateCommitmentltemResponse other = (UpdateCommitmentltemResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateCommitmentltemResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_FICOTRVi", ">updateCommitmentltemResponse"));
