...
public class UpdateFundcenterResponse  implements java.io.Serializable {
    private beans.ws.mdm.sap.com.ExecutionStatus[] response;

    public UpdateFundcenterResponse() {
    }
    ...
    /**
     * Gets the response value for this UpdateFundcenterResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this UpdateFundcenterResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateFundcenterResponse)) return false;
        UpdateFundcenterResponse other = (UpdateFundcenterResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateFundcenterResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:JSGX_MDM_FICOTRVi", ">updateFundcenterResponse"));
