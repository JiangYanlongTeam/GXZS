package weaver.interfaces.gx.jyl.extension.tzgl.dgfk;
...
import weaver.interfaces.gx.jyl.extension.tzgl.Mode.JTCLFBXZJZFCreateModel2;
import weaver.interfaces.gx.jyl.extension.tzgl.Mode.JTCLFBXZJZFCreate_HeadModel2;
...
public class JSTZGL_DGFKZJZFCreateAction_2010 extends BaseBean implements Action {
...
//				gyskhzh_value, zjysm_value, "(付款)" + zy_value, fjzs_value,fkflhh_value,fkfyhzh_value);
		...
		writeLog("对公付款傳入xml参数：" + xmlstring);
		...
		try {
			...
			if (null != map && !map.isEmpty()) {
				...
				if ("S".equalsIgnoreCase(type)) {
					...
					setFailMessage(request, "failed", "对公付款失败：TYPE：" + type
