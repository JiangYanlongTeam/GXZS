...
import weaver.interfaces.gx.jyl.extension.tzgl.Mode.DGYFKSFMode;
...
public class JSTZGL_DGYFKFAction_2010 extends BaseBean implements Action {
			...
			if (null != map && !map.isEmpty()) {
				...
				if (!"E".equalsIgnoreCase(type)) {
					...
					setFailMessage(request, "failed",
							"对公预付款失败：TYPE：" + type + " code：" + code + " message：" + message);
					return SUCCESS;
				}
			}
