...
public class JSTZGL_YBFYBXCreate_HeadModel {

	public JSTZGL_YBFYBXCreate_HeadModel() {
	}

	public JSTZGL_YBFYBXCreate_HeadModel(String cOMP_CODE, String dOC_TYPE, String dOC_DATE, String pSTNG_DATE,
