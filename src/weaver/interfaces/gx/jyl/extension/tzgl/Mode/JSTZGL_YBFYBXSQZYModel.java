...
public class JSTZGL_YBFYBXSQZYModel {
	...
	public JSTZGL_YBFYBXSQZYModel(){}



	public JSTZGL_YBFYBXSQZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JSTZGL_YBFYBXSQZYModel model = new JSTZGL_YBFYBXSQZYModel("1", "2", "3", "4", "5", "6", "7", "8", "9");
		try {
			String xmlstring = XMLUtil.beanToXml(model, JSTZGL_YBFYBXSQZYModel.class);
