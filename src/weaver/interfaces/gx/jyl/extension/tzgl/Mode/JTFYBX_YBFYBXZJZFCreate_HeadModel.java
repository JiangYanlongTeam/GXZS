...
public class JTFYBX_YBFYBXZJZFCreate_HeadModel {

	public JTFYBX_YBFYBXZJZFCreate_HeadModel() {
	}

	public JTFYBX_YBFYBXZJZFCreate_HeadModel(String zDJLX, String bUKRS, String gJAHR, String mONAT, String kOSTL,
