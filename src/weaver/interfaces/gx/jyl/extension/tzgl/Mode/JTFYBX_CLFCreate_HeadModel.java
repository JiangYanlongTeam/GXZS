...
public class JTFYBX_CLFCreate_HeadModel {

	public JTFYBX_CLFCreate_HeadModel() {
	}

	public JTFYBX_CLFCreate_HeadModel(String cOMP_CODE, String dOC_TYPE, String dOC_DATE, String pSTNG_DATE,
