...
public class JSTZGL_FYJKSFModel {
	...
	public JSTZGL_FYJKSFModel(){}

	public JSTZGL_FYJKSFModel(String bUKRS, String zJPZH, String zRELEASE,
                              String dMBTR) {
		super();
		BUKRS = bUKRS;
		ZJPZH = zJPZH;
	...
	public static void main(String[] args) {
		JSTZGL_FYJKSFModel model = new JSTZGL_FYJKSFModel("1", "2", "3", "4");
		try {
			String stringxml = XMLUtil.beanToXml(model, JSTZGL_FYJKSFModel.class);
