...
@XmlType(propOrder = { "SHKZG", "HKONT", "ZWLDW", "NAME1", "MWSKZ", "WRBTR", "DMBTR", "SGTXT", "XNEGP", "ZUONR",
		"KOSTL", "AUFNR", "POSID", "BUDG_CODE","FZHSID" })
public class JTFYBX_YBFYBXCreate_ItemModel_YYGS {
	...
	private String FZHSID;

	public JTFYBX_YBFYBXCreate_ItemModel_YYGS() {
	}

	public JTFYBX_YBFYBXCreate_ItemModel_YYGS(String sHKZG, String hKONT, String zWLDW, String nAME1, String mWSKZ, String wRBTR,
                                              String dMBTR, String sGTXT, String xNEGP, String zUONR, String kOSTL, String aUFNR, String pOSID,
                                              String bUDG_CODE, String fZHSID) {
		super();
		SHKZG = sHKZG;
		HKONT = hKONT;
		ZWLDW = zWLDW;
	...
	@XmlElement(name = "FZHSID")
	public String getFZHSID() {
		return FZHSID;
	}

	public void setFZHSID(String FZHSID) {
		this.FZHSID = FZHSID;
	}
