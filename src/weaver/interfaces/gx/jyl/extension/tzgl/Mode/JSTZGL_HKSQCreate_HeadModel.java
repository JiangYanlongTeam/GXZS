...
public class JSTZGL_HKSQCreate_HeadModel {
	

	public JSTZGL_HKSQCreate_HeadModel() {
	}

	public JSTZGL_HKSQCreate_HeadModel(String cOMP_CODE, String dOC_TYPE, String dOC_DATE, String pSTNG_DATE,
