...
public class JTFYBX_YBFYBXSQSFModel {
	...
	public JTFYBX_YBFYBXSQSFModel(){}

	public JTFYBX_YBFYBXSQSFModel(String bUKRS, String zJPZH, String zRELEASE,
			String dMBTR) {
		super();
		BUKRS = bUKRS;
		ZJPZH = zJPZH;
	...
	public static void main(String[] args) {
		JTFYBX_YBFYBXSQSFModel model = new JTFYBX_YBFYBXSQSFModel("1", "2", "3", "4");
		try {
			String xmlstring = XMLUtil.beanToXml(model, JTFYBX_YBFYBXSQSFModel.class);
