...
public class JTFYBX_CLFBXZYModel {
	...
	public JTFYBX_CLFBXZYModel(){}
	
	public JTFYBX_CLFBXZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JTFYBX_CLFBXZYModel model = new JTFYBX_CLFBXZYModel("1", "2", "3", "4", "5", "6", "7", "8", "9");
		try {
			String xml = XMLUtil.beanToXml(model, JTFYBX_CLFBXZYModel.class);
