...
@XmlType(propOrder = {"SHKZG","HKONT","ZWLDW","NAME1","MWSKZ","WRBTR","DMBTR","SGTXT","XNEGP","ZUONR","KOSTL","AUFNR","POSID","BUDG_CODE"})
public class JTFYBX_HKSQCreate_ItemModel {
	...
	public JTFYBX_HKSQCreate_ItemModel(){}

	public JTFYBX_HKSQCreate_ItemModel(String sHKZG, String hKONT, String zWLDW, String nAME1,
			String mWSKZ, String wRBTR, String dMBTR, String sGTXT,
			String xNEGP, String zUONR, String kOSTL, String aUFNR,
			String pOSID, String bUDG_CODE) {
		super();
		SHKZG = sHKZG;
		HKONT = hKONT;
		ZWLDW = zWLDW;
