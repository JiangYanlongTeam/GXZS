...
public class JTFYBX_YBFYBXSQZYModel {
	...
	public JTFYBX_YBFYBXSQZYModel(){}
	
	
	
	public JTFYBX_YBFYBXSQZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JTFYBX_YBFYBXSQZYModel model = new JTFYBX_YBFYBXSQZYModel("1", "2", "3", "4", "5", "6", "7", "8", "9");
		try {
			String xmlstring = XMLUtil.beanToXml(model, JTFYBX_YBFYBXSQZYModel.class);
