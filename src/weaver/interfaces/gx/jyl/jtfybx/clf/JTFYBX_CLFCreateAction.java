package weaver.interfaces.gx.jyl.jtfybx.clf;
...
import weaver.interfaces.gx.jyl.jtfybx.model.JTFYBX_CLFCreateModel;
import weaver.interfaces.gx.jyl.jtfybx.model.JTFYBX_CLFCreate_HeadModel;
import weaver.interfaces.gx.jyl.jtfybx.model.JTFYBX_CLFCreate_ItemModel;
 ...
 * 集团费用报销-差旅费报销创建生成凭证
 */
public class JTFYBX_CLFCreateAction extends BaseBean implements Action {
	...
	public String execute(RequestInfo request) {
		...
		String tablename = getPropValue("GXBX", "JTFYBX_CLFYBX");
					...
					if (null != map && !map.isEmpty()) {
						...
						if ("S".equalsIgnoreCase(ZSTATU)) {
							...
							publicmethod.setFailMessage(request, "failed",
									"集团费用报销-差旅费报销创建生成凭证创建失败：RET_ACCNO：" + RET_ACCNO
		...
		if ("0".equals(sfcxjk_value) && sbje_value.equals("0")) {
			...
			String jktable = getPropValue("GXBX", "JTFYBX_FYJK");
			String cltable = getPropValue("GXBX", "JTFYBX_CLFYBX");
	...
	public String getZYINFO(String fyxl) {
		RecordSet rs = new RecordSet();
		String fieldid = getPropValue("GXBX", "JTFYBX_FYXL_FIELDID");
