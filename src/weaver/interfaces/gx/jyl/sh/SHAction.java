package weaver.interfaces.gx.jyl.sh;
...
public class SHAction extends BaseBean implements Action {
	...
	public String execute(RequestInfo request) {
		...
		//ceshi 788
        String sql = "select a.requestid,b.EBELN,a.dhrq from formtable_main_864 a,formtable_main_864_dt1 b where a.id = b.mainid and a.requestid = '"+requestid+"' group by a.requestid,b.EBELN,a.dhrq";
        ...
        String sql2 = "update formtable_main_864 set shzt = '"+buffer.toString()+"' where requestid = '"+requestid+"'";
