...
public class RCGS_TYFYAction extends BaseBean implements Action {
    ...
    public String execute(RequestInfo request) {
        ...
        StringBuffer stringBuffer = new StringBuffer("支付");

        String sql = "select a.xjllxm,a.jehj,a.yhzf,a.kcxj,a.zffs,a.accounting_period,a.fjs,a.company,a.rq,a.enter,a.fiscal_year,b.mxyt,b.bxlx,a.bmbm,b.mxje from "+tableName+" a, "+tableName+"_dt1 b where a.id = b.mainid and a.requestid = '"+request.getRequestid()+"'";
        ...
        while (recordSet.next()) {
            ...
            mxyt = Util.null2String(recordSet.getString("mxyt"));
            ...
            zffs = Util.null2String(recordSet.getString("zffs"));
            yhzf = Util.null2String(recordSet.getString("yhzf"));
            kcxj = Util.null2String(recordSet.getString("kcxj"));
            jehj = Util.null2String(recordSet.getString("jehj"));
            xjllxm = Util.null2String(recordSet.getString("xjllxm"));


            stringBuffer.append(mxyt);
        ...
        String countSQL ="select sum(mxje) total from "+tableName+"_dt1 where mainid = (select id from "+tableName+" where REQUESTID = '"+request.getRequestid()+"')";
        ...
        entry1.setAbstracts(stringBuffer.toString());
        ...
        entry1.setPrimary_credit_amount(total);
        entry1.setSecondary_credit_amount("");
        entry1.setNatural_credit_currency(total);
        entry1.setBill_type("");
        entry1.setBill_id("");
        entry1.setBill_date("");
        ...
        Auxiliary_accounting auxiliary_accounting = new Auxiliary_accounting();
        Item item1 = new Item();
        item1.setName("现金流量项目");
        item1.setSpcecialitemvalue(xjllxm);
        auxiliary_accounting.setItem(item1);

        entry1.setAuxiliary_accounting(auxiliary_accounting);
