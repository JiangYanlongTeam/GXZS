...
public class RCGS_THMAction extends BaseBean implements Action {
    ...
    public String execute(RequestInfo request) {
        ...
        String sql = "select a.xjllxm,a.accounting_period,a.fjs,a.company,a.rq,a.enter,a.fiscal_year,a.yt mxyt,'' bxlx,a.bmbm,a.hkje mxje,a.hryh,a.hcyh from "+tableName+" a where a.requestid = '"+request.getRequestid()+"' ";
        ...
        while (recordSet.next()) {
            ...
            String hryh = Util.null2String(recordSet.getString("hryh"));
            String hcyh = Util.null2String(recordSet.getString("hcyh"));
        ...
        try {
            ...
            try {
                ...
                writeLog("人才公司同户名划转调用NC发送数据:" + xml);
                // 构建消息实体
