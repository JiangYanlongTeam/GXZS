...
public class DGFKSFMode {
	...
	public DGFKSFMode(String bUKRS, String zJPZH, String zRELEASE,
			String dMBTR) {
		super();
		BUKRS = bUKRS;
		ZJPZH = zJPZH;
	...
	public static void main(String[] args) {
		DGFKSFMode model = new DGFKSFMode("1", "2", "3", "4");
		try {
			String xml = XMLUtil.beanToXml(model, DGFKSFMode.class);
