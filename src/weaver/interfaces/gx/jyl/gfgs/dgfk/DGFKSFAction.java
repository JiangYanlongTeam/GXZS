 ...
 * 股份公司-对公付款释放
 */
public class DGFKSFAction extends BaseBean implements Action {
			...
			if (null != map && !map.isEmpty()) {
				...
				if (!"E".equalsIgnoreCase(type)) {
					...
					setFailMessage(request, "failed",
							"股份公司-对公付款失败：TYPE：" + type + " code：" + code + " message：" + message);
					return SUCCESS;
				}
			}
	...
	public void updateJTCLFBXSFDS(String requestid, String type, String code, String message, String bs) {
		...
		String sql = "update formtable_main_1104 set scode = '" + code + "', smessage = '" + message + "',stype = '"
