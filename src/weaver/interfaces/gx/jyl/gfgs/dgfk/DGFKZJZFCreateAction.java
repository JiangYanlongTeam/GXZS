 ...
 * 股份公司-对公付款资金支付单
 */
public class DGFKZJZFCreateAction extends BaseBean implements Action {
	...
	public String execute(RequestInfo request) {
		...
		writeLog("股份公司-对公付款傳入xml参数：" + xmlstring);
		...
		try {
			...
			if (null != map && !map.isEmpty()) {
				...
				if ("S".equalsIgnoreCase(type)) {
					...
					setFailMessage(request, "failed", "股份公司-对公付款失败：TYPE：" + type
    ...
    public void updateJTCLFXBXZJZFDDG(String requestid,
        ...
        String sql = "update formtable_main_1104 set capplyno = '"+no+"', ccode = '"+code+"', cmessage = '"+message+"',ctype = '"+type+"' where requestid = '"+requestid+"'";
        rs.execute(sql);
    }
}
