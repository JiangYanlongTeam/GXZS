 ...
 * 股份公司-股份公司冲销对公预付款通过
 */
public class CXDGYFKTGAction extends BaseBean implements Action {
	...
	public String execute(RequestInfo request) {
		...
		String sql = "update formtable_main_1105 set hkztje=nvl(hkztje,0)-'" + dou + "',ljhkje=nvl(ljhkje,0)+'" + dou
				+ "' where id='" + jkdh_value + "'  ";
