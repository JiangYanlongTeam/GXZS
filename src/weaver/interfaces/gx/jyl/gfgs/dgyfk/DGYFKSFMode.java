...
public class DGYFKSFMode {
	...
	public DGYFKSFMode(String bUKRS, String zJPZH, String zRELEASE,
			String dMBTR) {
		super();
		BUKRS = bUKRS;
		ZJPZH = zJPZH;
	...
	public static void main(String[] args) {
		DGYFKSFMode model = new DGYFKSFMode("1", "2", "3", "4");
		try {
			String xml = XMLUtil.beanToXml(model, DGYFKSFMode.class);
