...
public class JTCLFBXZYModel {
	...
	public JTCLFBXZYModel(){}
	
	public JTCLFBXZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JTCLFBXZYModel model = new JTCLFBXZYModel("1", "2", "3", "4", "5", "6", "7", "8", "9");
		try {
			String xml = XMLUtil.beanToXml(model, JTCLFBXZYModel.class);
