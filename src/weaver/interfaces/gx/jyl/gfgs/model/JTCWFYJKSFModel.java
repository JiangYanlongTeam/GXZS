...
public class JTCWFYJKSFModel {
	...
	public JTCWFYJKSFModel(){}

	public JTCWFYJKSFModel(String bUKRS, String zJPZH, String zRELEASE,
			String dMBTR) {
		super();
		BUKRS = bUKRS;
		ZJPZH = zJPZH;
	...
	public static void main(String[] args) {
		JTCWFYJKSFModel model = new JTCWFYJKSFModel("1", "2", "3", "4");
		try {
			String stringxml = XMLUtil.beanToXml(model, JTCWFYJKSFModel.class);
