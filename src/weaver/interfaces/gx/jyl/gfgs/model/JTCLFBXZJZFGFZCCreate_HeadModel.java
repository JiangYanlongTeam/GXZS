...
@XmlType(propOrder = { "ZDJLX", "BUKRS", "GJAHR", "MONAT", "KOSTL", "ZJPZH_ZY", "APPLYNO_EX", "ZFKLX", "LIFNR","EBELN","ABWHK", "BRPDT",
		"ZJBR", "SQJE_HSB", "WAERS", "PAY_DATE", "TR_TYPE", "RECE_ACC_NAME", "RECE_CNAPS", "RECE_ACC_NO", "BUDG_CODE",
		"ABSTRACT","NUMPG","PAYER_CNAPS","PAYBANK_NO" })


public class JTCLFBXZJZFGFZCCreate_HeadModel {

	public JTCLFBXZJZFGFZCCreate_HeadModel() {
	}

	public JTCLFBXZJZFGFZCCreate_HeadModel(String zDJLX, String bUKRS, String gJAHR, String mONAT, String kOSTL,
                                           String zJPZH_ZY, String aPPLYNO_EX, String zFKLX, String lIFNR, String eBELN, String aBWHK , String bRPDT, String zJBR, String sQJE_HSB,
