...
public class JTYBFYBXSQZYModel {
	...
	public JTYBFYBXSQZYModel(){}
	
	
	
	public JTYBFYBXSQZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JTYBFYBXSQZYModel model = new JTYBFYBXSQZYModel("1", "2", "3", "4", "5", "6", "7", "8", "9");
		try {
			String xmlstring = XMLUtil.beanToXml(model, JTYBFYBXSQZYModel.class);
