...
public class JTCWFYJKZYModel {
	...
	public JTCWFYJKZYModel(){}

	public JTCWFYJKZYModel(String bUKRS, String gJAHR, String mONAT,
	...
	public static void main(String[] args) {
		JTCWFYJKZYModel model = new JTCWFYJKZYModel("1", "2", "3", "4", "5", "6", "7", "8");
		try {
			String xml = XMLUtil.beanToXml(model, JTCWFYJKZYModel.class);
