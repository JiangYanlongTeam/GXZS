 ...
 * 股份公司-固定资产生成资金支付单
 */
public class GDZCZJZFCreateAction extends BaseBean implements Action {
	 ...
	 * @param message
	 */
	public void updateJTCLFXBXZJZFDDG(String requestid, String type, String code, String message, String no, String bs,
			String gysbm_value) {
		RecordSet rs = new RecordSet();
		String sql = "update formtable_main_864_dt1 set capplyno = '" + no + "', ccode = '" + code + "', cmessage = '"
