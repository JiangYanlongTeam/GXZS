...
public class GenerateCGDDAction extends BaseBean implements Action {
			...
			for(Entry<String,List<CGDDModel>> entry : map.entrySet()) {
				...
				try {
					...
					if(!resumap.isEmpty() && null != resumap) {
						...
						if("S".equals(result)) {
							String updatesql = "update formtable_main_864_dt1 set xx2 = '"+message+"',zt2 = '"+result+"',EBELN = '"+EBELN+"' where mainid = '"+mainid+"' and LIEFE = '"+LIFNR+"'";
