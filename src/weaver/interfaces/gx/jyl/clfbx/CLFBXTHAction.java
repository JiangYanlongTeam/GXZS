 ...
 * 差旅费报销退回
 */
public class CLFBXTHAction extends BaseBean implements Action {
	...
	public String execute(RequestInfo request) {
        ...
        writeLog("退回应该减去的金额："+ total);
        if("0".equals(sfcjk_value)) {
        	String tablename = getPropValue("GXBX", "CW_FYJK");
        	String sql = "update "+tablename+" set hkztje=nvl(hkztje,0)-'"+total+"' where id='"+jkdh_value+"'  ";
