...
public class F_FileAction extends BaseBean implements Action {
    ...
    public String execute(RequestInfo request) {
        ...
        String sql = "select a.ys,a.fjpdf, b.creater , a.field10, b.createdate,a.field02,a.field03,a.field05,a.field11,a.field08 from " + tableName + " a, workflow_requestbase b where a.requestid = b.requestid and a.requestid = '" + requestid + "'";
        RecordSet recordSet = new RecordSet();
        recordSet.execute(sql);
        recordSet.next();
        String field66 = Util.null2String(recordSet.getString("ys"));
        String fjpdf = Util.null2String(recordSet.getString("fjpdf"));
        String creater = Util.null2String(recordSet.getString("creater"));
        String field10 = Util.null2String(recordSet.getString("field10"));
        ...
        String fj = getMultiAttachNames(field10);


        String[] fjs = field10.split(",");



        String unit = "";
        try {
            creater = new ResourceComInfo().getSubCompanyID(creater);
            unit = new SubCompanyComInfo().getSubcompanynames(creater);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if(field10.equals("")) {
            ...
            efilecount = Util.null2String(field10.split(",").length + 2);
        }
        ...
        if (field02.equals("")) {
            ...
            try {
                unit = new SubCompanyComInfo().getSubcompanynames(field02);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        String insertMainSQL = "insert into OA_D_FILE (ID,STATUS,CREATOR,CREATETIME,UNIT,EFILECOUNT,EXTID,TITLE,CWRQ,ZRZ,WH,YS,FJ) values " +
                ...
                "'" + m_dfile.getZrz() + "','" + m_dfile.getWh() + "','"+field66+"','"+fj+"')";
