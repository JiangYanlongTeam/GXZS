...
public class MEINS__Lookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public MEINS__Lookup() {
    }
    ...
    /**
     * Gets the displayValue value for this MEINS__Lookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this MEINS__Lookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this MEINS__Lookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this MEINS__Lookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MEINS__Lookup)) return false;
        MEINS__Lookup other = (MEINS__Lookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MEINS__Lookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MEINS__Lookup"));
