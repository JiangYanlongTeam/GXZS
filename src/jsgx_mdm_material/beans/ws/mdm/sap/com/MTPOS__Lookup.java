...
public class MTPOS__Lookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public MTPOS__Lookup() {
    }
    ...
    /**
     * Gets the displayValue value for this MTPOS__Lookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this MTPOS__Lookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this MTPOS__Lookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this MTPOS__Lookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MTPOS__Lookup)) return false;
        MTPOS__Lookup other = (MTPOS__Lookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MTPOS__Lookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MTPOS__Lookup"));
