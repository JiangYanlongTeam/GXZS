...
public class MEINS__Query  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.MEINS__Criteria criteria;
    ...
    public MEINS__Query(
           jsgx_mdm_material.beans.ws.mdm.sap.com.MEINS__Criteria criteria,
    ...
    /**
     * Gets the criteria value for this MEINS__Query.
     * 
     * @return criteria
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.MEINS__Criteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this MEINS__Query.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_material.beans.ws.mdm.sap.com.MEINS__Criteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this MEINS__Query.
     * 
    ...
    /**
     * Sets the resultDefinition value for this MEINS__Query.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MEINS__Query)) return false;
        MEINS__Query other = (MEINS__Query) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MEINS__Query.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MEINS__Query"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MEINS__Criteria"));
