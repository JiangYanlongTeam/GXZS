...
public class OperationResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.Operation[] operation;
    ...
    public OperationResultSet(
           ...
           jsgx_mdm_material.beans.ws.mdm.sap.com.Operation[] operation) {
        super(
            executionStatus);
     ...
     * @return operation
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.Operation[] getOperation() {
        return operation;
    }
     ...
     * @param operation
     */
    public void setOperation(jsgx_mdm_material.beans.ws.mdm.sap.com.Operation[] operation) {
        this.operation = operation;
    }

    public jsgx_mdm_material.beans.ws.mdm.sap.com.Operation getOperation(int i) {
        return this.operation[i];
    }

    public void setOperation(int i, jsgx_mdm_material.beans.ws.mdm.sap.com.Operation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "OperationResultSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "Operation"));
