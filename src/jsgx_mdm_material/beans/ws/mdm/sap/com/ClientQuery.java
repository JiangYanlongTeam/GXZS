...
public class ClientQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.ClientCriteria criteria;
    ...
    public ClientQuery(
           jsgx_mdm_material.beans.ws.mdm.sap.com.ClientCriteria criteria,
    ...
    /**
     * Gets the criteria value for this ClientQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.ClientCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this ClientQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_material.beans.ws.mdm.sap.com.ClientCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this ClientQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this ClientQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClientQuery)) return false;
        ClientQuery other = (ClientQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClientQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "ClientQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "ClientCriteria"));
