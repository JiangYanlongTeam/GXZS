...
public class MaterialTypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this MaterialTypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this MaterialTypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this MaterialTypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this MaterialTypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MaterialTypeLookup)) return false;
        MaterialTypeLookup other = (MaterialTypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MaterialTypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialTypeLookup"));
