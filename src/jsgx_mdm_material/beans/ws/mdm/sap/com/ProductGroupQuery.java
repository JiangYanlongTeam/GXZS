...
public class ProductGroupQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.ProductGroupCriteria criteria;
    ...
    public ProductGroupQuery(
           jsgx_mdm_material.beans.ws.mdm.sap.com.ProductGroupCriteria criteria,
    ...
    /**
     * Gets the criteria value for this ProductGroupQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.ProductGroupCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this ProductGroupQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_material.beans.ws.mdm.sap.com.ProductGroupCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this ProductGroupQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this ProductGroupQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProductGroupQuery)) return false;
        ProductGroupQuery other = (ProductGroupQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProductGroupQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "ProductGroupQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "ProductGroupCriteria"));
