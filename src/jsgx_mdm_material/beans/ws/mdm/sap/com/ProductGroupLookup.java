...
public class ProductGroupLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this ProductGroupLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this ProductGroupLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this ProductGroupLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this ProductGroupLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProductGroupLookup)) return false;
        ProductGroupLookup other = (ProductGroupLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProductGroupLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "ProductGroupLookup"));
