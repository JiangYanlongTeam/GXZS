...
public class MATKL__Lookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public MATKL__Lookup() {
    }
    ...
    /**
     * Gets the displayValue value for this MATKL__Lookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this MATKL__Lookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this MATKL__Lookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this MATKL__Lookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MATKL__Lookup)) return false;
        MATKL__Lookup other = (MATKL__Lookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MATKL__Lookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MATKL__Lookup"));
