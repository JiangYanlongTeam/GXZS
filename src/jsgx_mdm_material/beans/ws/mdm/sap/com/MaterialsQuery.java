...
public class MaterialsQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCriteria criteria;
    ...
    public MaterialsQuery(
           jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCriteria criteria,
    ...
    /**
     * Gets the criteria value for this MaterialsQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this MaterialsQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_material.beans.ws.mdm.sap.com.MaterialsCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this MaterialsQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this MaterialsQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MaterialsQuery)) return false;
        MaterialsQuery other = (MaterialsQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MaterialsQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MaterialsCriteria"));
