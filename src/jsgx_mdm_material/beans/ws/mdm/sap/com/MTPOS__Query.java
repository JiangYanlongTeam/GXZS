...
public class MTPOS__Query  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_material.beans.ws.mdm.sap.com.MTPOS__Criteria criteria;
    ...
    public MTPOS__Query(
           jsgx_mdm_material.beans.ws.mdm.sap.com.MTPOS__Criteria criteria,
    ...
    /**
     * Gets the criteria value for this MTPOS__Query.
     * 
     * @return criteria
     */
    public jsgx_mdm_material.beans.ws.mdm.sap.com.MTPOS__Criteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this MTPOS__Query.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_material.beans.ws.mdm.sap.com.MTPOS__Criteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this MTPOS__Query.
     * 
    ...
    /**
     * Sets the resultDefinition value for this MTPOS__Query.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MTPOS__Query)) return false;
        MTPOS__Query other = (MTPOS__Query) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MTPOS__Query.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MTPOS__Query"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_material", "MTPOS__Criteria"));
