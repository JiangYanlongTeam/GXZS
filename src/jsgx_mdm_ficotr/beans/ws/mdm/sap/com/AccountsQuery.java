...
public class AccountsQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountsCriteria criteria;
    ...
    public AccountsQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountsCriteria criteria,
    ...
    /**
     * Gets the criteria value for this AccountsQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountsCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this AccountsQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountsCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this AccountsQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this AccountsQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccountsQuery)) return false;
        AccountsQuery other = (AccountsQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccountsQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountsQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountsCriteria"));
