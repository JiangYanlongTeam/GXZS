...
public class AccountTypeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountTypeCriteria criteria;
    ...
    public AccountTypeQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountTypeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this AccountTypeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountTypeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this AccountTypeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountTypeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this AccountTypeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this AccountTypeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccountTypeQuery)) return false;
        AccountTypeQuery other = (AccountTypeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccountTypeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountTypeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountTypeCriteria"));
