/**
 * CommitmentItemCategoryLookup.java
 *
...
public class CommitmentItemCategoryLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public CommitmentItemCategoryLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this CommitmentItemCategoryLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CommitmentItemCategoryLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CommitmentItemCategoryLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CommitmentItemCategoryLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommitmentItemCategoryLookup)) return false;
        CommitmentItemCategoryLookup other = (CommitmentItemCategoryLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CommitmentItemCategoryLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "CommitmentItemCategoryLookup"));
