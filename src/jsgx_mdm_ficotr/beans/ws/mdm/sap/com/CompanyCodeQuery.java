...
public class CompanyCodeQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.CompanyCodeCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public CompanyCodeQuery() {
    }

    public CompanyCodeQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.CompanyCodeCriteria criteria,
    ...
    /**
     * Gets the criteria value for this CompanyCodeQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.CompanyCodeCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this CompanyCodeQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.CompanyCodeCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this CompanyCodeQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this CompanyCodeQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CompanyCodeQuery)) return false;
        CompanyCodeQuery other = (CompanyCodeQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CompanyCodeQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "CompanyCodeQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "CompanyCodeCriteria"));
