...
public class AccountGroupQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountGroupCriteria criteria;
    ...
    public AccountGroupQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountGroupCriteria criteria,
    ...
    /**
     * Gets the criteria value for this AccountGroupQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountGroupCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this AccountGroupQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.AccountGroupCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this AccountGroupQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this AccountGroupQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccountGroupQuery)) return false;
        AccountGroupQuery other = (AccountGroupQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccountGroupQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountGroupQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountGroupCriteria"));
