...
public class AccountTypeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    /**
     * Gets the displayValue value for this AccountTypeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this AccountTypeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this AccountTypeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this AccountTypeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccountTypeLookup)) return false;
        AccountTypeLookup other = (AccountTypeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccountTypeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountTypeLookup"));
