...
public class FundcenterResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter[] fundcenter;
    ...
    public FundcenterResultSet(
           ...
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter[] fundcenter) {
        super(
            executionStatus);
     ...
     * @return fundcenter
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter[] getFundcenter() {
        return fundcenter;
    }
     ...
     * @param fundcenter
     */
    public void setFundcenter(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter[] fundcenter) {
        this.fundcenter = fundcenter;
    }

    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter getFundcenter(int i) {
        return this.fundcenter[i];
    }

    public void setFundcenter(int i, jsgx_mdm_ficotr.beans.ws.mdm.sap.com.Fundcenter _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "FundcenterResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fundcenter");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "fundcenter"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "Fundcenter"));
