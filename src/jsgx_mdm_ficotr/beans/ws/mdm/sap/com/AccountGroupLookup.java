...
public class AccountGroupLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public AccountGroupLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this AccountGroupLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this AccountGroupLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this AccountGroupLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this AccountGroupLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccountGroupLookup)) return false;
        AccountGroupLookup other = (AccountGroupLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccountGroupLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "AccountGroupLookup"));
