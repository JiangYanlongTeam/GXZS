...
public class ProductsQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ProductsCriteria criteria;
    ...
    public ProductsQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ProductsCriteria criteria,
    ...
    /**
     * Gets the criteria value for this ProductsQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ProductsCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this ProductsQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ProductsCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this ProductsQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this ProductsQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProductsQuery)) return false;
        ProductsQuery other = (ProductsQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProductsQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "ProductsQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "ProductsCriteria"));
