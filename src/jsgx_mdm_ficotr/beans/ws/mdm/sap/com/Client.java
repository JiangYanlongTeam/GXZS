...
public class Client  extends jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ClientUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "Client"));
