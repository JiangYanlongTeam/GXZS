...
public class ApprovalStatusResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus;
    ...
    public ApprovalStatusResultSet(
           ...
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus) {
        super(
            executionStatus);
     ...
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus[] getApprovalStatus() {
        return approvalStatus;
    }
     ...
     */
    public void setApprovalStatus(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus) {
        this.approvalStatus = approvalStatus;
    }

    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus getApprovalStatus(int i) {
        return this.approvalStatus[i];
    }

    public void setApprovalStatus(int i, jsgx_mdm_ficotr.beans.ws.mdm.sap.com.ApprovalStatus _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "ApprovalStatusResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("approvalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "approvalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "ApprovalStatus"));
