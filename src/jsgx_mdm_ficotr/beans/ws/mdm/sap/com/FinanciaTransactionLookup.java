/**
 * FinanciaTransactionLookup.java
 *
...
public class FinanciaTransactionLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public FinanciaTransactionLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this FinanciaTransactionLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this FinanciaTransactionLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this FinanciaTransactionLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this FinanciaTransactionLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FinanciaTransactionLookup)) return false;
        FinanciaTransactionLookup other = (FinanciaTransactionLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FinanciaTransactionLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "FinanciaTransactionLookup"));
