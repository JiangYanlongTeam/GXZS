...
public class FundcenterQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.FundcenterCriteria criteria;

    private beans.ws.mdm.sap.com.ResultDefinition resultDefinition;

    public FundcenterQuery() {
    }

    public FundcenterQuery(
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.FundcenterCriteria criteria,
    ...
    /**
     * Gets the criteria value for this FundcenterQuery.
     * 
     * @return criteria
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.FundcenterCriteria getCriteria() {
        return criteria;
    }


    /**
     * Sets the criteria value for this FundcenterQuery.
     * 
     * @param criteria
     */
    public void setCriteria(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.FundcenterCriteria criteria) {
        this.criteria = criteria;
    }


    /**
     * Gets the resultDefinition value for this FundcenterQuery.
     * 
    ...
    /**
     * Sets the resultDefinition value for this FundcenterQuery.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FundcenterQuery)) return false;
        FundcenterQuery other = (FundcenterQuery) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FundcenterQuery.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "FundcenterQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "FundcenterCriteria"));
