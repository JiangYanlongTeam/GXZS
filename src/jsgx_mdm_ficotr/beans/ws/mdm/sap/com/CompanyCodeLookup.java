...
public class CompanyCodeLookup  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private java.lang.String displayValue;

    private beans.ws.mdm.sap.com.BasicRecordIdentification recordIdentification;

    public CompanyCodeLookup() {
    }
    ...
    /**
     * Gets the displayValue value for this CompanyCodeLookup.
     * 
     * @return displayValue
     */
    ...
    /**
     * Sets the displayValue value for this CompanyCodeLookup.
     * 
     * @param displayValue
     */
    ...
    /**
     * Gets the recordIdentification value for this CompanyCodeLookup.
     * 
    ...
    /**
     * Sets the recordIdentification value for this CompanyCodeLookup.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CompanyCodeLookup)) return false;
        CompanyCodeLookup other = (CompanyCodeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CompanyCodeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "CompanyCodeLookup"));
