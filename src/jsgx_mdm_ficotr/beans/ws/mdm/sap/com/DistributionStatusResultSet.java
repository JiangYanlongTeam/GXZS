...
public class DistributionStatusResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus;
    ...
    public DistributionStatusResultSet(
           ...
           jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus) {
        super(
            executionStatus);
     ...
     */
    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus[] getDistributionStatus() {
        return distributionStatus;
    }
     ...
     */
    public void setDistributionStatus(jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus) {
        this.distributionStatus = distributionStatus;
    }

    public jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus getDistributionStatus(int i) {
        return this.distributionStatus[i];
    }

    public void setDistributionStatus(int i, jsgx_mdm_ficotr.beans.ws.mdm.sap.com.DistributionStatus _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "DistributionStatusResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("distributionStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "distributionStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.jsgx_mdm_ficotr", "DistributionStatus"));
